  ...
  <div class="container">
    ...
    <el-form :model="form1" label-width="auto" style="width: 800px">
      ...
      <el-form-item label="选择不动产所在学区">
        <el-select v-if="radio1 == 1" v-model="form1.name5" placeholder="选择报名学校">
        ...
        <el-select v-if="radio1 == 2" v-model="form1.name5" placeholder="选择报名学校">
...
const next = () => {
  ...
  localStorage.setItem('table15', JSON.stringify(form1.value));
  return router.push('./cltj15');
}
