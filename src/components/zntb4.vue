...
<h1>片区类产权房报名题目</h1>
  ...
  <div class="container">
    ...
    <el-form :model="form1" label-width="auto" style="width: 800px">
      ...
      <el-form-item label="不动产房产坐落地址">
        <el-input v-model="form1.name6" placeholder="必填" />
      </el-form-item>

      <el-form-item label="请选择不动产所有人与学生的关系">
      ...
      <el-form-item label="父亲姓名" v-if="form1.name5 == 1">
        <el-input v-model="form1.name7" placeholder="单亲家庭可在父亲、母亲中选填一项" />
      </el-form-item>

      <el-form-item label="父亲身份证号码" v-if="form1.name5 == 1">
        <el-input v-model="form1.name8" placeholder="单亲家庭可在父亲、母亲中选填一项" />
      </el-form-item>

      <el-form-item label="母亲姓名" v-if="form1.name5 == 1">
        <el-input v-model="form1.name9" placeholder="单亲家庭可在父亲、母亲中选填一项" />
      </el-form-item>

      <el-form-item label="母亲身份证号码" v-if="form1.name5 == 1">
        <el-input v-model="form1.name10" placeholder="单亲家庭可在父亲、母亲中选填一项" />
      </el-form-item>

      <el-form-item label="监护人姓名" v-if="form1.name5 == 2">
        <el-input v-model="form1.name11" placeholder="必填" />
      </el-form-item>

      <el-form-item label="监护人身份证号码" v-if="form1.name5 == 2">
        <el-input v-model="form1.name12" placeholder="必填" />
      </el-form-item>

      <el-form-item label="(外)祖父姓名" v-if="form1.name5 == 3">
        <el-input v-model="form1.name13" placeholder="请至少填一项祖父或祖母的完整信息" />
      </el-form-item>

      <el-form-item label="(外)祖父身份证号码" v-if="form1.name5 == 3">
        <el-input v-model="form1.name14" placeholder="请至少填一项祖父或祖母的完整信息" />
      </el-form-item>

      <el-form-item label="(外)祖母姓名" v-if="form1.name5 == 3">
        <el-input v-model="form1.name15" placeholder="请至少填一项祖父或祖母的完整信息" />
      </el-form-item>

      <el-form-item label="(外)祖母身份证号码" v-if="form1.name5 == 3">
        <el-input v-model="form1.name16" placeholder="请至少填一项祖父或祖母的完整信息" />
      </el-form-item>
...
onMounted(() => {
  ...
  const table4 = localStorage.getItem('table4');
  if (table4) {
    const data = JSON.parse(table4);
    form1.value = data;
  }
...
const next = () => {
  ...
  localStorage.setItem('table4', JSON.stringify(form1.value));
  return router.push('./cltj4');
}
